class MealPlansController < ApplicationController
  ...
  def build_days(params)
    days = []
    params['rest'].count.times do |i|
      day = {}
      day['rest'] = params['rest'][i]
      day['very_light'] =  params['very_light'][i]
      day['light'] =  params['light'][i]
      day['moderate'] =  params['moderate'][i]
      day['heavy'] =  params['heavy'][i]
      days << day
    end
    return days
  end
